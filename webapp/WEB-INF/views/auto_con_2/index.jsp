...
<body>
  <div class="auto-con">
    ...
    <div class="pre-text">예열로 자동운전 조건</div>
    <div class="rectangle-1">연속로 오토콘</div>
    ...
    <div class="div">만족</div>
    <div class="rectangle-22"></div>
    <div class="div2">불만족</div>
    <div class="pre-text2">연속로입구 자동운전 조건</div>
    ...
    <div class="div3">만족</div>
    <div class="rectangle-44"></div>
    <div class="div4">불만족</div>
    <div class="pre-text3">연속로출구 자동운전 조건</div>
    ...
    <div class="div5">만족</div>
    <div class="rectangle-66"></div>
    <div class="div6">불만족</div>
    <div class="pre-text4">유조 자동운전 조건</div>
    ...
    <div class="div7">만족</div>
    <div class="rectangle-88"></div>
    <div class="div8">불만족</div>
  </div>
